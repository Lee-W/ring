...
1 → 2 是主線,必須依序;3、4、5 彼此獨立,可穿插;6 依賴 3 的等待原因分類。
...
- **🟡 閒置太久提醒**(原第 7 項,0.8.0 曾實作 `idle_threshold_seconds`,2026-07-10 移除):碰到 session limit 時 session 會長時間閒置,這個提醒反覆打擾,弊大於利。
